const localData = {
  ...
  starships: [
    ...
    {
        "name": "TEST Sentinel-class landing craft", 
    ...
    {
        "name": "TEST EF76 Nebulon-B escort frigate", 
